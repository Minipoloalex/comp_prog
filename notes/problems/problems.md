...
- Cut and Paste: simple **implicit Treap**
- Substring Reversals: **implicit Treap** with **reverse Lazy propagation**
- Reversals and Sums: similar to substring reversals, with an additional info variable (sum).
